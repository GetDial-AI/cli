...
- **Show a typing indicator while composing** — `dial typing start --to-number +14155550123`, then `dial typing stop --to-number +14155550123` when you're done; it never clears on its own. iMessage numbers display it; SMS numbers ignore it, so it's always safe to call ([commands.md](https://docs.getdial.ai/documentation/reference/commands.md))
