...
const inputSchema = {
  ...
  explicitProgrammaticConsent: z.string().min(1).describe("Required attestation that the account holder consented to provisioning this number programmatically; stored on the number"),
