  ...
  run: async (args) =>
    jsonResult({
      number: await setNumberProperties({
        ...
        ...(args.inboundLanguage !== undefined ? { inboundLanguage: args.inboundLanguage as string } : {}),
        ...(args.nickname !== undefined ? { nickname: args.nickname as string } : {}),
        ...(args.maxCallDurationSeconds !== undefined ? { maxCallDurationSeconds: args.maxCallDurationSeconds as number | null } : {}),
      }),
    }),
};
